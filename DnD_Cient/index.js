...
app.get('/', function(req, res){
	...
	res.sendFile(__dirname + '/index.html'); //HTML document here
...
/*
app.get('/scripts/Boot.js', function(req, res){

	res.sendFile(__dirname + '/scripts/Boot.js');
...
app.get('/scripts/Menu.js', function(req, res){

	res.sendFile(__dirname + '/scripts/Menu.js');
...
app.get('/Content/TileSet.png', function(req, res){

	res.sendFile(__dirname + '/Content/TileSet.png');

});

app.get('/Content/test.json', function(req, res) {

	res.sendFile(__dirname + '/Content/test.json');
